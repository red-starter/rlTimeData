...
.controller('graphController',function($scope,Data,Input){
	...
	//$scope.xaxis
	var xAxisArr = _.pluck($scope.userInput,'population')
	var yAxisArr = _.pluck($scope.userInput,'GDP')
	...
	var initGraph = function(){
		...
		svg.selectAll("circle").data($scope.userInput,function(e,i){ console.log(e); return e['country']})
			.enter()
			.append("circle")
